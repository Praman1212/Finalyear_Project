...
<head>
    ...
    <title>Home | HamroCollection</title>
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Jackets</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Sunglasses</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Tshirts</a></h4>
								</div>
							</div>
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 <input type="text" class="span2" value="" data-slider-min="0" data-slider-max="50000" data-slider-step="100" data-slider-value="[5000,30000]" id="sl2" ><br />
								 <b class="pull-left">Rs 0</b> <b class="pull-right">Rs 50000</b>
							</div>
						</div><!--/price-range-->
...
=======
											<img src="images/shoes/airjordan5.png" alt="" />
											<h2>Rs 8000</h2>
											<p>Nike Air Jordan 5</p>
>>>>>>> da043b8d83aa23f4d8fb9593e2f33282b241a326
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="{{ URL::to('product-details') }}"><i class="fa fa-plus-square"></i>Product Details</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/jacket/sample.jpg" alt="" />
										<h2>Rs 4500</h2>
										<p>Leather Jacket</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/pants/sample1.jpg" alt="" />
										<h2>Rs 2500</h2>
										<p>Jeans Pant</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shirt/shirt1.jpg" alt="" />
										<h2>Rs 1800</h2>
										<p>Formal Shirt</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shorts/sample3.jpg" alt="" />
										<h2>Rs 1200</h2>
										<p>Half Pant</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/sunglasses/sample4.jpg" alt="" />
										<h2>Rs 1600</h2>
										<p>Ray Ban Sunglass</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
									<!--<div class="product-overlay">
										<div class="overlay-content">
